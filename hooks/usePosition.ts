...
export const parseMyPositions = (
  ...
  return {
    ...
    market: {
      marketPair: getMarketPairByPubkey(info.parimutuel.marketKey, web3),
      duration,
      status: marketStatus,
