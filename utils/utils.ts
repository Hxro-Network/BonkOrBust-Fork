import { CryptoEnum, getMarketPubkeys, MarketPairEnum, ParimutuelMarket, ParimutuelWeb3 } from "@hxronetwork/parimutuelsdk";
...
export const getMarketPairByPubkey = (marketKey: string, web3?: ParimutuelWeb3): string => {
