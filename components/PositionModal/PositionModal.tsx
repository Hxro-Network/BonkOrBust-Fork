...
export const PositionModal: React.FC = () => {
  const { selectedParimutuel, positionSide, decimalPlaces, selectedNetwork } = useSetting();
  ...
  const [play] = useSound(clickSound); //Change to BONK
  ...
  return (
    <Modal isOpen={isPositionShown} onClose={handleClose}>
      <ModalOverlay />
      <ModalContent className="mobile-entry-modal" overflow="hidden" bgColor="brand.200">
          ...
          <Flex flexDirection="column" my="12px">
            ...
            >
              ...
              <Text textStyle="small" color="white" ml="4px">
                ...
                (`Available Funds: ${bonkBalance.cryptoAmount} BONK`) :
                (`Available Funds: ${usdcBalance.cryptoAmount} USDC`)}
              </Text>
            </Flex>
